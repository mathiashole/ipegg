...
Here is the complete Markdown code for your README.md. I have adapted the examples to use Saccharomyces cerevisiae (Yeast) as you requested, specifically focusing on common yeast domains like WD40 and Kinases.
Markdown
